Automated Narrative Generator - WEB interface

 * This web interface is Copyright (C) 2013 Fabio Corubolo - corubolo@gmail.com

The narrative generator was developed by Fabio Corubolo and Meriem Bendis under guidance from Paul Watry.

This is the web interface package of the narrative generator, and uses the main package.
