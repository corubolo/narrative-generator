...
//    private boolean allowForcedLandmarks;
    ...
    private Map<Proposition, ArrayList<Proposition>> naturalOrderings, 
        necessaryOrderings, 
...
//
//        this.naturalOrderings = new MapWrapper<Proposition, ArrayList<Proposition>>();
//        this.necessaryOrderings = new MapWrapper<Proposition, ArrayList<Proposition>>();
//        this.greedyNecessaryOrderings = new MapWrapper<Proposition, ArrayList<Proposition>>();
//        this.impossibleOrderings = new MapWrapper<Proposition, ArrayList<Proposition>>();
//    }
...
//    	this.allowForcedLandmarks = allowForcedLandmarks;
        ...
        for (Object o : this.gproblem.goal.getFacts())
        {
//            System.out.println("goal condition is instance of : "+o.getClass().getCanonicalName());
        ...
        for (Object o : this.gproblem.actions)
        {
...
//        		if (foundOne == false) 
//        		{
//        			HashSet<Action> allApplicable = new SetWrapper<Action>();
...
//        		}
    		...
    		{
    			boolean found = false;
	        	for (Object initPropObj : this.init.facts)
	        	{
