...
public class PredicateSymbol implements PDDLPrintable, Serializable
{
	...
	protected List<Parameter> params = new FastArrayList<Parameter>(); // The parameters (types) that
