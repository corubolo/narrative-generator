			...
			Comparable<TimeStampedAction>
{
	...
	public int compareTo(TimeStampedAction o)
	{
		...
		else
		{
			...
			return ((new Integer(this.getAction().hashCode())).compareTo(new Integer(
					that.getAction().hashCode())));
		}
	}
	...
	public boolean equals(Object obj)
	{
		...
		if (this.cost.equals(other.cost) == false || this.getTime().equals(other.getTime()) == false)
			return false;
