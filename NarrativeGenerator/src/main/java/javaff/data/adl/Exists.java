...
public class Exists implements GroundFact, UngroundFact, CompoundLiteral, Quantifier, ADLFact
{
...
//	private Set<Fact> grounded;
	...
	protected Exists(Variable v, Fact c, boolean grounded)
	{
		this.variable = v;
		this.condition = c;
//		this.grounded = new SetWrapper<Fact>();
...
//		{
//			LinkedHashSet<Fact> stillValid = new SetWrapper<Fact>();
//			
...
//		}
//		else
			return new Exists(this.variable, ((GroundFact)this.condition).staticify(fValues), true); //TODO check this works...
//			return this;
	}
...
//	}
	...
	{
		Set<STRIPSFact> groundedFacts = new SetWrapper<STRIPSFact>();
